...
public class signupTwo extends JFrame implements ActionListener {
    ...
    signupTwo(String formno) {
        ...
        cardnum.setFont(new Font("Raleway", Font.PLAIN, 12));
        cardnum.setBounds(100, 240, 300, 20);
        add(cardnum);

        JLabel number = new JLabel("XXXX-XXXX-XXXX-1224");
        ...
        services.setBounds(100, 320, 250, 30);
        add(services);
